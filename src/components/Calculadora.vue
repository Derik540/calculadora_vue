                ...
                <div class="row">
                    <div class="col">
                        <div class="form-group mb-5">
                            <select v-model="operadorSelecionado" class="form-control">
                    ...
                    <div class="col">
                        <div class="form-group mb-2">
                            <input type="number" v-model="numero1" class="form-control"
                                placeholder="Digite o primeiro número" @change="calcular" @keyup="calcular">
                        </div>
                    </div>
                    <div class="col">
                        <div class="form-group mb-2">
                            <input type="number" v-model="numero2" class="form-control"
                                placeholder="Digite o segundo número" @change="calcular" @keyup="calcular">
                        </div>
                    </div>
                </div>
